...
Public Class dlgSettings
    ...
    Sub New(_settings As Configuration.Face)
    ...
    Private Sub loadItems()
        cbTemplateSize.Items.AddRange({NTemplateSize.Compact.ToString, NTemplateSize.Small.ToString,
        ...
        cbLivenessMode.Items.AddRange({NLivenessMode.Active.ToString, NLivenessMode.Passive.ToString,
                                       NLivenessMode.PassiveAndActive.ToString, NLivenessMode.Simple.ToString,
